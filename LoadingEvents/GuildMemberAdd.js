...
class Uye {
  ...
  async Hoşgeldin(uye) {
    let  ibidises1 = this.uye.guild.channels.cache.get("Register 1 Kanal ID")
    let  ibidises2 = this.uye.guild.channels.cache.get("Register 2 Kanal ID")
    let  ibidises3 = this.uye.guild.channels.cache.get("Register 3 Kanal ID")
    let  ibidises4 = this.uye.guild.channels.cache.get("Register 4 Kanal ID")
    
    var dizi = [`${ ibidises1.members.size}`, `${ ibidises2.members.size}`, `${ ibidises3.members.size}`, `${ ibidises4.members.size}`]
    ...
    if( ibidises4.members.size == kanalenbuyuk) ibidiseskanallar =  ibidises4;     
